...
if (
    process.env.XIMEIURL &&
    process.env.XIMEIURL.indexOf(COOKIES_SPLIT) > -1
  ) {
    ximeiurl = process.env.XIMEIURL.split(COOKIES_SPLIT);
  } else {
    ximeiurl = process.env.XIMEIURL.split();
  }
  if (
    process.env.XIMEIHD &&
    process.env.XIMEIHD.indexOf(COOKIES_SPLIT) > -1
  ) {
    ximeihd = process.env.XIMEIHD.split(COOKIES_SPLIT);
  } else {
    ximeihd = process.env.XIMEIHD.split();
  }
