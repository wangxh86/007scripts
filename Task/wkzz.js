...
if (
    process.env.WKZZURL &&
    process.env.WKZZURL.indexOf(COOKIES_SPLIT) > -1
  ) {
    wkzzurl = process.env.WKZZURL.split(COOKIES_SPLIT);
  } else {
    wkzzurl = process.env.WKZZURL.split();
  }
  if (
    process.env.WKZZHD &&
    process.env.WKZZHD.indexOf(COOKIES_SPLIT) > -1
  ) {
    wkzzhd = process.env.WKZZHD.split(COOKIES_SPLIT);
  } else {
    wkzzhd = process.env.WKZZHD.split();
  }
  if (
    process.env.WKZZID &&
    process.env.WKZZID.indexOf(COOKIES_SPLIT) > -1
  ) {
    wkzzid = process.env.WKZZID.split(COOKIES_SPLIT);
  } else {
    wkzzid = process.env.WKZZID.split();
  }
